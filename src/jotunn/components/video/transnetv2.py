...
class TransNetV2Segmentation:
    ...
    def __init__(
        self,
        url="https://github.com/SlimRG/transnetv2pt/raw/master/transnetv2pt/transnetv2-pytorch-weights.pth",
    ):
    ...
    def save_scenes_from_video(
        ...
        progress_bar = (
            tqdm(total=len(scenes), desc="Saving scenes", unit="clip")
            if show_progressbar
            else None
        )
        ...
        for idx, (start, end) in enumerate(scenes):
            ...
            out = cv2.VideoWriter(
                clip_path, cv2.VideoWriter_fourcc(*codec), fps, (width, height)
            )
